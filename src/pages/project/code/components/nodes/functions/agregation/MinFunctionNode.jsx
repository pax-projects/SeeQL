...
const MinFunctionNode = (props) => {
	...
	return (<div className="min-func-node func-node node">
		<div className="node-name">
			<div className="flex-row-between">
				<h3>Min</h3>
				<HandleWithValidation type="source" position="right" nodeID={props.id} handleID={"min-function-handle"} constraints={connectionPoints}/>
			</div>
		</div>
		<MonoFieldComponent
			...
			nodeID={props.id}
			handleID={["min-func-column-name", "func-field-handle"]}
			onUpdate={update}
		/>
	</div>);
}
...
export default memo(MinFunctionNode, areEqual);